...
16. **Not yet done, needs the couple's input:** real descriptions for Ceremonia/Cóctel/Cena/Fiesta in the schedule, guest list itself, Apps Script deployment + `APPS_SCRIPT_URL` wiring, DNS check for `bodabetinamiguel.dpdns.org`, real event/schedule/contact/RSVP section photos, real floral corner artwork
